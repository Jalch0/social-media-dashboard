...
## A little changes about the responsive model

In the original project there is only a responsive model for devices with 375px and 1440px. I made a new responsive model for the best experience on devices with 480px, 768px, 1024px.
